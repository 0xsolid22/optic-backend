...
export const VOTING_ABI = [
  {
    inputs: [
      ...
      { internalType: 'uint256', name: '_candidatesCount', type: 'uint256' },
    ],
  ...
  { inputs: [], name: 'VoteNotAvailable', type: 'error' },
  {
    anonymous: false,
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: true, internalType: 'uint256', name: 'candidate', type: 'uint256' },
